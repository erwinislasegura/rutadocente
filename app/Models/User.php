...
class User extends BaseModel {
 ...
 public function updateProfile(int $id,array $d):void{$s=$this->db()->prepare('UPDATE users SET first_name=?,last_name=?,phone=? WHERE id=?');$s->execute([$d['first_name'],$d['last_name'],$d['phone'],$id]);}
}
